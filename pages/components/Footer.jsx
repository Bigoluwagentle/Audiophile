  ...
  return (
    <footer id={Styles.footer}>
        <section>
            ...
            <img src="/Bitmap-image.png" alt="Bitmap-image" />
        </section>
        <footer>
            <section>
